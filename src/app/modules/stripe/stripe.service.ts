...
const createAccountLink = async (userId: string) => {
    ...
    const accountLink = await stripe.accountLinks.create({
        ...
        refresh_url: `${config.front_end_app_url}/billing?screen=stripe-connected&connectedAccountId=${connected_id}` as string,
        return_url: `${config.front_end_app_url}?screen=stripe-connected&connectedAccountId=${connected_id}` as string,
